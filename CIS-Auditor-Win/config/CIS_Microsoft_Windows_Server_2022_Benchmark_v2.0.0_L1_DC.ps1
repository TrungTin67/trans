...
Write-Output '====';
Get-ItemPropertyValue -Path 'HKLM:\System\Currentcontrolset\Control\Lsa' -Name 'SubmitControl';
Write-Output '====';
...
Write-Output '====';
Get-ItemPropertyValue -Path 'HKLM:\System\Currentcontrolset\Services\Netlogon\Parameters' -Name 'RefusePasswordChange';
Write-Output '====';
...
Write-Output '====';
Get-ItemPropertyValue -Path 'HKLM:\System\Currentcontrolset\Services\Spooler' -Name 'Start';
Write-Output '====';
...
Write-Output '====';
Get-ItemPropertyValue -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\Kernel DMA Protection' -Name 'DeviceEnumerationPolicy';
Write-Output '====';
...
Write-Output '====';
Get-ItemPropertyValue -Path 'HKLM:\Software\Microsoft\Windows\CurrentVersion\Policies\System\SAM' -Name 'SamNGCKeyROCAValidation';
Write-Output '====';
...
Write-Output '====';
Get-Content -Path C:\temp\secpol.cfg | Select-String -Pattern 'SeMachineAccountPrivilege';
Write-Output '====';
...
Write-Output '====';
Get-Content -Path C:\temp\secpol.cfg | Select-String -Pattern 'SeSyncAgentPrivilege';
Write-Output '====';
...
Write-Output '====';
auditpol /get /subcategory:'Kerberos Authentication Service' | select-string -pattern 'Kerberos Authentication Service';
Write-Output '====';
auditpol /get /subcategory:'Kerberos Service Ticket Operations' | select-string -pattern 'Kerberos Service Ticket Operations';
Write-Output '====';
auditpol /get /subcategory:'Application Group Management' | select-string -pattern 'Application Group Management';
Write-Output '====';
auditpol /get /subcategory:'Computer Account Management' | select-string -pattern 'Computer Account Management';
Write-Output '====';
auditpol /get /subcategory:'Distribution Group Management' | select-string -pattern 'Distribution Group Management';
Write-Output '====';
auditpol /get /subcategory:'Other Account Management Events' | select-string -pattern 'Other Account Management Events';
Write-Output '====';
...
Write-Output '====';
auditpol /get /subcategory:'Directory Service Access' | select-string -pattern 'Directory Service Access';
Write-Output '====';
auditpol /get /subcategory:'Directory Service Changes' | select-string -pattern 'Directory Service Changes';
Write-Output '====';
...
Get-ItemPropertyValue -Path 'HKLM:\System\CurrentControlSet\Services\Netlogon\Parameters' -Name 'VulnerableChannelAllowList';
Write-Output '====';
